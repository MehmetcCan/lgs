...
exports.run = async(client, message, args) => {
    if (!args[0]) return message.channel.send(`Merhaba Sahibim kara liste özelliğini kullanmak istiyor iseniz **/karaliste al** yazınız. Kara listedeki birini çıkartmak istiyor iseniz **/beyaz-liste al** komutunu kullanınız!`) 
  if (args[0] === 'al') {
