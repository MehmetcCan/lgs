...
await (member.roles.add(role.id))
 message.channel.send(new Emran.MessageEmbed().setTitle("Electro Bot | Rol Verme Sistemi ").setDescription(`${member} isimli üyeye \`${role.name}\` isimli yetki başarıyla verildi!`)  .setFooter('Bu komutu kullanan yetkili ' + message.author.tag, message.author.avatarURL).setColor('#D2EE07'));
