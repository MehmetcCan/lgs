...
exports.run = async (client, message, args) => {
  ////--------------------------------------------\\\\       
  let prefix = "/"
  let sahip = '730096504647188531' //Premium verebilicek / alabilecek kişiler
  let log = client.channels.cache.get('814895116463505428') // logların tutulcağı kanal
  ////--------------------------------------------\\\\     
...
.setFooter(`Electro | Premium Sistemi`)
.setTimestamp())   
}}
////----------------------\\\\ PREMİUM VER ////----------------------\\\\   
  if(args[0] === 'ver') {
